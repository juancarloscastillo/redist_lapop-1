...
colnames(lp081) <- c("country","year", "id", "weight1500", "redistribution", "man", "age", "married", "ideology", "employment", "education", "income", "zone", "sizecity", "trustffaa", "trustpolice", "trustjudicial", "trustexecutive", "trustcongress", "trustpolparties", "children")
head (lp081)
#2010
...
colnames(lp101) <- c("country","year", "id", "weight1500", "redistribution", "man", "age", "married", "ideology", "employment", "education", "income", "zone", "sizecity", "trustffaa", "trustpolice", "trustjudicial", "trustexecutive", "trustcongress", "trustpolparties", "children")
head (lp101)
#2012
...
colnames(lp121) <- c("country","year", "id", "weight1500" , "redistribution", "man", "age", "married", "ideology", "employment", "education", "income", "zone", "sizecity", "trustffaa", "trustpolice", "trustjudicial", "trustexecutive", "trustcongress", "trustpolparties", "children")
head (lp121)
#2014
...
colnames(lp141) <- c("country","year", "id", "weight1500", "redistribution", "man", "age", "married", "ideology", "employment", "education", "income", "zone", "sizecity", "trustffaa", "trustpolice", "trustjudicial", "trustexecutive", "trustcongress", "trustpolparties", "children")
head (lp141)
#Merge Databases
...
figureb <- bar_redistributionb + geom_bar(stat = "summary") + 
  facet_wrap(~lapop1$country_name, ncol = 3) +
  coord_flip() +
  scale_x_continuous(breaks = unique(lapop1$decil_f)) +
  scale_y_continuous(breaks = c(0:7),labels=c(0:7),limits=c(0,7)) +
...
model_w8 = lmer(redistribution ~ 1 + quintil_f + man + age + married_f 
                ...
                + zone + gini_mean + gini_dif
                + pib_mean + pib_dif
                + quintil_f*pib_mean + quintil_f*pib_dif + year
                + (1 + quintil_f | country_wave) + (1 + quintil_f | country), data=lapop1, weights=wt)
screenreg(model_w8)
...
model_w8 = lmer(redistribution ~ 1 + decil_d + man + age + married_f 
                ...
                + zone + gini_mean + gini_dif
                + pib_mean + pib_dif
                + decil_f*pib_mean + decil_f*pib_dif + year
                + (1 + decil_f | country_wave) + (1 + decil_f | country), data=lapop1)
screenreg(model_w8)
...
plot_model(model_w2, show.intercept = TRUE , show.values = TRUE, vline.color = "black", value.offset = .3, transform = NULL, sort.est = T ,title = "Coefficients of an OLS regression model 2", dot.size = 1, colors="darkgrey") 
```
