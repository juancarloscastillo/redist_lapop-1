...
lpop$redistribucion_r <-as.factor(lpop$redistribucion_r)
...
freq(lpop$quintil[lpop$pais=="MEX" & lpop$year==2008])
freq(lpop$quintil[lpop$pais=="MEX" & lpop$year==2010])
freq(lpop$quintil[lpop$pais=="MEX" & lpop$year==2012])
freq(lpop$quintil[lpop$pais=="MEX" & lpop$year==2014])
...
freq(lpop$decil)
#México a modo de ejemplo
freq(lpop$decil[lpop$pais=="MEX" & lpop$year==2008])
freq(lpop$decil[lpop$pais=="MEX" & lpop$year==2010])
freq(lpop$decil[lpop$pais=="MEX" & lpop$year==2012])
freq(lpop$decil[lpop$pais=="MEX" & lpop$year==2014])
...
lapop = na.omit(lpop)
lapop = lpop[complete.cases(lpop$redistribucion, lpop$sexo, lpop$edad, lpop$ecivil, 
                              lpop$izquierda, lpop$ideopolitica_f, lpop$sitlaboral, 
                              lpop$educacion, lpop$decil, lpop$zona,lpop$confianza),]

lapop2 = complete.cases(lpop)
...
#Variable wt
lpop$wt_m <- lpop$wt
lpop$wt_m <- ifelse(is.na(lpop$wt_m), 1, 0)
lpop$wt_m <-as.factor(lpop$wt_m)
describe(lpop$wt)
describe(lpop$wt_m)
table1 <- xtabs(~wt_m+pais+wave, data=lpop)
table1

#Variable ingreso_pc
lpop$ingreso_pc_m <- lpop$ingreso_pc
lpop$ingreso_pc_m <- ifelse(is.na(lpop$ingreso_pc_m), 1, 0)
lpop$ingreso_pc_m <- as.factor(lpop$ingreso_pc_m)
describe(lpop$ingreso_pc_m)
describe(lpop$ingreso_pc_m)
table2 <- xtabs(~ingreso_pc_m+pais+wave, data=lpop)
table2

#Variable ideología política
lpop$ideopolitica_f_m <- lpop$ideopolitica_f
lpop$ideopolitica_f_m <- ifelse(is.na(lpop$ideopolitica_f_m), 1, 0)
lpop$wt_m <-as.factor(lpop$ideopolitica_f_m)
describe(lpop$ideopolitica_f)
describe(lpop$ideopolitica_f_m)
table3 <- xtabs(~lpop$ideopolitica_f_m+pais+wave, data=lpop)
table3
